...
WANDB_PROJECT=COMMONSENCE_SFT_LLAMA-3_1-70B
WANDB_PREFIX=llm.llama-3_1-70b
    ...
    do
        ...
        do
            ...
            then
                ...
                CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nnodes 1 --nproc_per_node 8 $WORK_DIR/finetune_commonsense.py \
